...
export type IUserAccountState = IPaginationBaseState;

export class UserAccount extends React.Component<IUserAccountProps, IUserAccountState> {
  ...
  render() {
    const { userAccountList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="user-account-heading">
          User Accounts
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp; Create new User Account
          </Link>
        </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('recruiter')}>
                  Recruiter <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('receiveMailing')}>
                  Receive Mailing <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {userAccountList.map((userAccount, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{userAccount.activated ? 'true' : 'false'}</td>
                  <td>{userAccount.recruiter ? 'true' : 'false'}</td>
                  <td>{userAccount.receiveMailing ? 'true' : 'false'}</td>
...
const mapStateToProps = ({ userAccount }: IRootState) => ({
  ...
  totalItems: userAccount.totalItems
});
